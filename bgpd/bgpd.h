...
#define BGP_CONFIG_DAMPENING              (1 << 0)
  ...
  u_char redist[AFI_MAX][KROUTE_ROUTE_MAX];

  /* BGP redistribute metric configuration. */
  u_char redist_metric_flag[AFI_MAX][KROUTE_ROUTE_MAX];
  u_int32_t redist_metric[AFI_MAX][KROUTE_ROUTE_MAX];
...
struct peer
{
   ...
   *
   * named 'lock' for hysterical reasons within Bane.
   */
  int lock;
