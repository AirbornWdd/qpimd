/* kroute connection and redistribute fucntions.
...
#ifndef _BANE_BGP_KROUTE_H
#define _BANE_BGP_KROUTE_H

#define BGP_NEXTHOP_BUF_SIZE (8 * sizeof (struct in_addr *))

extern struct stream *bgp_nexthop_buf;

extern void bgp_kroute_init (void);
...
extern int bgp_config_write_redistribute (struct vty *, struct bgp *, afi_t, safi_t,
				   int *);
extern void bgp_kroute_announce (struct prefix *, struct bgp_info *, struct bgp *, safi_t);
extern void bgp_kroute_withdraw (struct prefix *, struct bgp_info *, safi_t);
