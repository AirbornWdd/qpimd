#!/usr/bin/perl
##
## Kroute Looking Glass version 1.0
## 01 FEB 2000
...
<html>
<head>
<title>Multi-Router Looking Glass for Kroute</title>
</head>
<body bgcolor=white>
	
<font face=arial size=3 color=blue>
<h1>Multi-Router Looking Glass for Kroute</h1>
...
Multi-Router Looking Glass for Kroute version 1.0<br>
...
## $server is the IP address of the router running kroute
## $login_pass is the password of the router
## $bgpd is the port that bgpd will answer on
## $kroute is the port that kroute will answer on
## if $kroute is "", it will disable sh ip route and sh int for that router.
