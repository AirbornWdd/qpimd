...
#ifndef _KROUTE_ZSERV_H
#define _KROUTE_ZSERV_H
...
#define KROUTE_VTY_PORT                2601

/* Default configuration filename. */
#define DEFAULT_CONFIG_FILE "kroute.conf"
...
extern void kroute_if_init (void);
extern void kroute_zserv_socket_init (char *path);
extern void hostinfo_get (void);
extern void rib_init (void);
extern void interface_list (void);
extern void kernel_init (void);
extern void route_read (void);
extern void kroute_route_map_init (void);
extern void kroute_snmp_init (void);
extern void kroute_vty_init (void);
