...
"\r\n\
Hello, this is " BANE_PROGNAME " (version " BANE_VERSION ").\r\n\
" BANE_COPYRIGHT "\r\n\
\r\n";
...
DEFUN (show_version,
       ...
       "show version",
       SHOW_STR
       "Displays kroute version\n")
{
  vty_out (vty, "Bane %s (%s).%s", BANE_VERSION, host.name?host.name:"",
	   VTY_NEWLINE);
  vty_out (vty, "%s%s", BANE_COPYRIGHT, VTY_NEWLINE);
...
{
  vty_out (vty, 
	   "Bane VTY provides advanced help feature.  When you need help,%s\
