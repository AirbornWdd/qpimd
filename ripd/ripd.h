 ...
 * Copyright (C) 1997, 1998, 1999 Kunihiro Ishiguro <kunihiro@kroute.org>
 *
...
#ifndef _KROUTE_RIP_H
#define _KROUTE_RIP_H
...
extern void rip_kroute_ipv4_add (struct prefix_ipv4 *, struct in_addr *, u_int32_t, u_char);
extern void rip_kroute_ipv4_delete (struct prefix_ipv4 *, struct in_addr *, u_int32_t);
