...
struct variable kroute_variables[] = 
  {
...
proto_trans(int type)
{
  switch (type)
    {
    case KROUTE_ROUTE_SYSTEM:
      return 1; /* other */
    case KROUTE_ROUTE_KERNEL:
      return 1; /* other */
    case KROUTE_ROUTE_CONNECT:
      return 2; /* local interface */
    case KROUTE_ROUTE_STATIC:
      return 3; /* static route */
    case KROUTE_ROUTE_RIP:
      return 8; /* rip */
    case KROUTE_ROUTE_RIPNG:
      return 1; /* shouldn't happen */
    case KROUTE_ROUTE_OSPF:
      return 13; /* ospf */
    case KROUTE_ROUTE_OSPF6:
      return 1; /* shouldn't happen */
    case KROUTE_ROUTE_BGP:
      return 14; /* bgp */
    default:
      return 1; /* other */
    }
...
kroute_snmp_init ()
{
  smux_init (krouted.master);
  REGISTER_MIB("mibII/ipforward", kroute_variables, variable, ipfw_oid);
}
#endif /* HAVE_SNMP */
