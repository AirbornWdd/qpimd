...
#ifndef _KROUTE_OSPF_KROUTE_H
#define _KROUTE_OSPF_KROUTE_H
...
#define DEFAULT_ROUTE		    KROUTE_ROUTE_MAX
...
extern void ospf_kroute_add (struct prefix_ipv4 *, struct ospf_route *);
extern void ospf_kroute_delete (struct prefix_ipv4 *, struct ospf_route *);

extern void ospf_kroute_add_discard (struct prefix_ipv4 *);
extern void ospf_kroute_delete_discard (struct prefix_ipv4 *);
...
extern int ospf_distance_unset (struct vty *, struct ospf *, const char *,
				const char *, const char *);
extern void ospf_kroute_init (void);

#endif /* _KROUTE_OSPF_KROUTE_H */
