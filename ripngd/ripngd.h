...
#ifndef _KROUTE_RIPNG_RIPNGD_H
#define _KROUTE_RIPNG_RIPNGD_H
...
extern void ripng_terminate (void);
 /* zclient_init() is done by ripng_kroute.c:kroute_init() */
extern void kroute_init (void);
...
extern void ripng_kroute_ipv6_add (struct prefix_ipv6 *p,
                                  struct in6_addr *nexthop,
                                  unsigned int ifindex, u_char metric);
extern void ripng_kroute_ipv6_delete (struct prefix_ipv6 *p,
                                     struct in6_addr *nexthop,
                                     unsigned int ifindex);
...
extern int ripng_interface_up (int command, struct zclient *, kroute_size_t);
extern int ripng_interface_down (int command, struct zclient *, kroute_size_t);
extern int ripng_interface_add (int command, struct zclient *, kroute_size_t);
extern int ripng_interface_delete (int command, struct zclient *, kroute_size_t);
extern int ripng_interface_address_add (int command, struct zclient *, kroute_size_t);
extern int ripng_interface_address_delete (int command, struct zclient *, kroute_size_t);

extern int ripng_network_write (struct vty *, int);

#endif /* _KROUTE_RIPNG_RIPNGD_H */
