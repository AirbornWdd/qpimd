...
struct kroute_privs_t ospf6d_privs =
{
...
\n\
Report bugs to kroute@kroute.org\n", progname);
    }
...
struct bane_signal_t ospf6_signals[] =
{
  {
    .signal = SIGHUP,
    .handler = &sighup,
...
main (int argc, char *argv[], char *envp[])
{
  ...
  /* Print start message */
  zlog_notice ("OSPF6d (Bane-%s ospf6d-%s) starts: vty@%d",
               BANE_VERSION, OSPF6_DAEMON_VERSION,vty_port);
