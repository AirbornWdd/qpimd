...
connected_up_ipv4 (struct interface *ifp, struct connected *ifc)
{
  ...
  rib_add_ipv4 (KROUTE_ROUTE_CONNECT, 0, &p, NULL, NULL, ifp->ifindex,
...
connected_down_ipv4 (struct interface *ifp, struct connected *ifc)
{
  ...
  rib_delete_ipv4 (KROUTE_ROUTE_CONNECT, 0, &p, NULL, ifp->ifindex, 0, SAFI_UNICAST);
...
connected_up_ipv6 (struct interface *ifp, struct connected *ifc)
{
  ...
  rib_add_ipv6 (KROUTE_ROUTE_CONNECT, 0, &p, NULL, ifp->ifindex, RT_TABLE_MAIN,
...
connected_down_ipv6 (struct interface *ifp, struct connected *ifc)
{
  ...
  rib_delete_ipv6 (KROUTE_ROUTE_CONNECT, 0, &p, NULL, ifp->ifindex, 0, SAFI_UNICAST);
