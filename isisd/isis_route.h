 ...
 */
#ifndef _KROUTE_ISIS_ROUTE_H
#define _KROUTE_ISIS_ROUTE_H
...
#define ISIS_ROUTE_FLAG_KROUTE_SYNCED 0x02  /* set when route synced to kroute */
#define ISIS_ROUTE_FLAG_KROUTE_RESYNC 0x04  /* set when route needs to sync */
  u_char flag;
  u_int32_t cost;
  u_int32_t depth;
