...
struct memory_list memory_list_kroute[] = 
{
...
{
  {MTYPE_PIM,                         "PIM"},
  {MTYPE_PIM_VIF,                     "PIM Vif"},
  {MTYPE_PIM_NEIGHBOR,                "PIM neighbor"},
  {MTYPE_PIM_MIB_NEIGHBOR,            "PIM MIB neighbor"},
  {MTYPE_PIM_SG,                      "PIM SG"},
  {MTYPE_PIM_G,                       "PIM G"},
  {MTYPE_PIM_SRC,                     "PIM src"},
  {MTYPE_PIM_GROUP,                   "PIM group"},
  {MTYPE_PIM_MRT,                     "PIM MRT"},
  {MTYPE_PIM_STATUS,                  "PIM status"},
  {MTYPE_PIM_RP,                      "PIM RP"},
  {MTYPE_PIM_BSR,                     "PIM BSR"},
  {MTYPE_PIM_RP_SET,                  "PIM RP SET"},
  {MTYPE_PIM_NEXTHOP,                 "PIM nexthop"},
  {MTYPE_PIM_OIF,                     "PIM OIF"},
  {MTYPE_PIM_RP_XX,                   "PIM RP XX"},
  {MTYPE_PIM_REG,                     "PIM reg"},
  {MTYPE_PIM_XG_S_FCR,                "PIM (*,G) FCR"},
  {MTYPE_PIM_HELLO_ADDR,              "PIM Hello Secondary Addresses"},
  {MTYPE_PIM_ST_RP_CONF,              "PIM Static RP configuration"},
  {MTYPE_PIM_CRP,                     "PIM Candidate-RP"},
  {MTYPE_PIM_CRP_GRP_RNG,             "PIM Candidate-RP Group Range"},
  {MTYPE_PIM_VIF_LOCAL_INFO,          "PIM Vif local info"},  
  { -1, NULL },
};
