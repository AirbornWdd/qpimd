...
/* Add kroute route map rule */
static int
kroute_route_match_add(struct vty *vty, struct route_map_index *index,
...
/* Delete kroute route map rule. */
static int
kroute_route_match_delete (struct vty *vty, struct route_map_index *index,
			const char *command, const char *arg)
{
  int ret;
...
/* Add kroute route map rule. */
static int
kroute_route_set_add (struct vty *vty, struct route_map_index *index,
		   const char *command, const char *arg)
{
  int ret;
...
/* Delete kroute route map rule. */
static int
kroute_route_set_delete (struct vty *vty, struct route_map_index *index,
		      const char *command, const char *arg)
{
  int ret;
...
DEFUN (match_interface,
       ...
       "Interface name\n")
{
  return kroute_route_match_add (vty, vty->index, "interface", argv[0]);
}
...
{
  if (argc == 0)
    return kroute_route_match_delete (vty, vty->index, "interface", NULL);

  return kroute_route_match_delete (vty, vty->index, "interface", argv[0]);
}
...
DEFUN (match_ip_next_hop,
       ...
       "IP Access-list name\n")
{
  return kroute_route_match_add (vty, vty->index, "ip next-hop", argv[0]);
}
...
{
  if (argc == 0)
    return kroute_route_match_delete (vty, vty->index, "ip next-hop", NULL);

  return kroute_route_match_delete (vty, vty->index, "ip next-hop", argv[0]);
}
...
DEFUN (match_ip_next_hop_prefix_list,
       ...
       "IP prefix-list name\n")
{
  return kroute_route_match_add (vty, vty->index, "ip next-hop prefix-list", argv[0]);
}
...
{
  if (argc == 0)
    return kroute_route_match_delete (vty, vty->index, "ip next-hop prefix-list", NULL);

  return kroute_route_match_delete (vty, vty->index, "ip next-hop prefix-list", argv[0]);
}
...
{
  return kroute_route_match_add (vty, vty->index, "ip address", argv[0]);
}
...
{
  if (argc == 0)
    return kroute_route_match_delete (vty, vty->index, "ip address", NULL);

  return kroute_route_match_delete (vty, vty->index, "ip address", argv[0]);
}
...
DEFUN (match_ip_address_prefix_list, 
       ...
       "IP prefix-list name\n")
{
  return kroute_route_match_add (vty, vty->index, "ip address prefix-list", argv[0]);
}
...
{
  if (argc == 0)
    return kroute_route_match_delete (vty, vty->index, "ip address prefix-list", NULL);

  return kroute_route_match_delete (vty, vty->index, "ip address prefix-list", argv[0]);
}
       ...
       "src address\n")
{
  ...
  return kroute_route_set_add (vty, vty->index, "src", argv[0]);
}
...
{
  if (argc == 0)
    return kroute_route_set_delete (vty, vty->index, "src", NULL);

  return kroute_route_set_delete (vty, vty->index, "src", argv[0]);
}
