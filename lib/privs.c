 ...
 */
static kroute_privs_current_t zprivs_null_state = ZPRIVS_RAISED;
...
#ifdef HAVE_CAPABILITIES
int zprivs_change_caps (kroute_privs_ops_t);
kroute_privs_current_t zprivs_state_caps (void);
#endif /* HAVE_CAPABILITIES */
int zprivs_change_uid (kroute_privs_ops_t);
kroute_privs_current_t zprivs_state_uid (void);
int zprivs_change_null (kroute_privs_ops_t);
kroute_privs_current_t zprivs_state_null (void);

#ifdef HAVE_CAPABILITIES
/* internal capability API */
static pset_t *zcaps2sys (kroute_capabilities_t *, int);
static void zprivs_caps_init (struct kroute_privs_t *);
static void zprivs_caps_terminate (void);

/* Map of Bane abstract capabilities to system capabilities */
static struct
{
  int num;
...
{
#ifdef HAVE_LCAPS /* Bane -> Linux capabilities mappings */
  ...
  /* Bane -> Solaris privilege mappings */
...
/* convert kroutes privileges to system capabilities */
static pset_t *
zcaps2sys (kroute_capabilities_t *zcaps, int num)
{
  pset_t *syscaps;
  int i, j = 0, count = 0;
...
int 
zprivs_change_caps (kroute_privs_ops_t op)
{
...
static void
zprivs_caps_init (struct kroute_privs_t *zprivs)
{
...

int
zprivs_change_uid (kroute_privs_ops_t op)
{
...
int
zprivs_change_null (kroute_privs_ops_t op)
{
  return 0;
}
...
void
zprivs_init(struct kroute_privs_t *zprivs)
{
...
void 
zprivs_terminate (struct kroute_privs_t *zprivs)
{
  if (!zprivs)
    {
