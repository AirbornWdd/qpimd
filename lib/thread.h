...
#ifndef _KROUTE_THREAD_H
#define _KROUTE_THREAD_H
...
/* Clocks supported by Bane */
enum bane_clkid {
  BANE_CLK_REALTIME = 0,	/* ala gettimeofday() */
  BANE_CLK_MONOTONIC,		/* monotonic, against an indeterminate base */
  BANE_CLK_REALTIME_STABILISED, /* like realtime, but non-decrementing */
};
 ...
 */
extern int bane_gettime (enum bane_clkid, struct timeval *);
extern time_t bane_time (time_t *);
