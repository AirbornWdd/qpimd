...
#ifndef _KROUTE_RIB_H
#define _KROUTE_RIB_H
...
#define RIB_ROUTE_QUEUED(x)	(1 << (x))
  ...
  /* Flags of this route.
   * This flag's definition is in lib/kroute.h KROUTE_FLAG_* and is exposed
...
#define STATIC_IPV4_BLACKHOLE   3
  ...
  u_char flags;
/*
 see KROUTE_FLAG_REJECT
     KROUTE_FLAG_BLACKHOLE
 */
};
...
#define KROUTE_RIB_LOOKUP_ERROR -1
#define KROUTE_RIB_FOUND_EXACT 0
#define KROUTE_RIB_FOUND_NOGATE 1
#define KROUTE_RIB_FOUND_CONNECTED 2
#define KROUTE_RIB_NOTFOUND 3
