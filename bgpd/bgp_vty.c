...
/* For old version Kroute compatibility.  */
...
#define BGP_UPDATE_SOURCE_HELP_STR \
  "IPv4 address\n" \
  "IPv6 address\n" \
  "Interface name (requires kroute to be running)\n"
...
DEFUN (bgp_redistribute_ipv4,
       ...
       "redistribute " BANE_IP_REDIST_STR_BGPD,
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD)
{
  int type;

  type = proto_redistnum (AFI_IP, argv[0]);
  if (type < 0 || type == KROUTE_ROUTE_BGP)
    {
...
DEFUN (bgp_redistribute_ipv4_rmap,
       ...
       "redistribute " BANE_IP_REDIST_STR_BGPD " route-map WORD",
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
       "Route map reference\n"
...
DEFUN (bgp_redistribute_ipv4_metric,
       ...
       "redistribute " BANE_IP_REDIST_STR_BGPD " metric <0-4294967295>",
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
...
DEFUN (bgp_redistribute_ipv4_rmap_metric,
       ...
       "redistribute " BANE_IP_REDIST_STR_BGPD " route-map WORD metric <0-4294967295>",
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
       "Route map reference\n"
       "Pointer to route-map entries\n"
...
DEFUN (bgp_redistribute_ipv4_metric_rmap,
       ...
       "redistribute " BANE_IP_REDIST_STR_BGPD " metric <0-4294967295> route-map WORD",
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
       "Metric for redistributed routes\n"
       "Default metric\n"
...
DEFUN (no_bgp_redistribute_ipv4,
       ...
       "no redistribute " BANE_IP_REDIST_STR_BGPD,
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD)
{
...
DEFUN (no_bgp_redistribute_ipv4_rmap,
       ...
       "no redistribute " BANE_IP_REDIST_STR_BGPD " route-map WORD",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
       "Route map reference\n"
...
DEFUN (no_bgp_redistribute_ipv4_metric,
       ...
       "no redistribute " BANE_IP_REDIST_STR_BGPD " metric <0-4294967295>",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
       "Metric for redistributed routes\n"
...
DEFUN (no_bgp_redistribute_ipv4_rmap_metric,
       ...
       "no redistribute " BANE_IP_REDIST_STR_BGPD " route-map WORD metric <0-4294967295>",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
       "Route map reference\n"
...
ALIAS (no_bgp_redistribute_ipv4_rmap_metric,
       ...
       "no redistribute " BANE_IP_REDIST_STR_BGPD " metric <0-4294967295> route-map WORD",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP_REDIST_HELP_STR_BGPD
       "Metric for redistributed routes\n"
...
DEFUN (bgp_redistribute_ipv6,
       ...
       "redistribute " BANE_IP6_REDIST_STR_BGPD,
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD)
{
  int type;
...
DEFUN (bgp_redistribute_ipv6_rmap,
       ...
       "redistribute " BANE_IP6_REDIST_STR_BGPD " route-map WORD",
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Route map reference\n"
       "Pointer to route-map entries\n")
...
DEFUN (bgp_redistribute_ipv6_metric,
       ...
       "redistribute " BANE_IP6_REDIST_STR_BGPD " metric <0-4294967295>",
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Metric for redistributed routes\n"
       "Default metric\n")
...
DEFUN (bgp_redistribute_ipv6_rmap_metric,
       ...
       "redistribute " BANE_IP6_REDIST_STR_BGPD " route-map WORD metric <0-4294967295>",
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Route map reference\n"
       "Pointer to route-map entries\n"
...
DEFUN (bgp_redistribute_ipv6_metric_rmap,
       ...
       "redistribute " BANE_IP6_REDIST_STR_BGPD " metric <0-4294967295> route-map WORD",
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Metric for redistributed routes\n"
       "Default metric\n"
...
DEFUN (no_bgp_redistribute_ipv6,
       ...
       "no redistribute " BANE_IP6_REDIST_STR_BGPD,
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD)
{
...
DEFUN (no_bgp_redistribute_ipv6_rmap,
       ...
       "no redistribute " BANE_IP6_REDIST_STR_BGPD " route-map WORD",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Route map reference\n"
...
DEFUN (no_bgp_redistribute_ipv6_metric,
       ...
       "no redistribute " BANE_IP6_REDIST_STR_BGPD " metric <0-4294967295>",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Metric for redistributed routes\n"
...
DEFUN (no_bgp_redistribute_ipv6_rmap_metric,
       ...
       "no redistribute " BANE_IP6_REDIST_STR_BGPD " route-map WORD metric <0-4294967295>",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Route map reference\n"
...
ALIAS (no_bgp_redistribute_ipv6_rmap_metric,
       ...
       "no redistribute " BANE_IP6_REDIST_STR_BGPD " metric <0-4294967295> route-map WORD",
       NO_STR
       "Redistribute information from another routing protocol\n"
       BANE_IP6_REDIST_HELP_STR_BGPD
       "Metric for redistributed routes\n"
  ...
  for (i = 0; i < KROUTE_ROUTE_MAX; i++)
    {
      ...
      if (bgp->redist[afi][i] && i != KROUTE_ROUTE_BGP)
	{
	  /* Display "address-family" when it is not yet diplayed.  */
	  bgp_config_write_family_header (vty, afi, safi, write);

	  /* "redistribute" configuration.  */
	  vty_out (vty, " redistribute %s", kroute_route_string(i));
