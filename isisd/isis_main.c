...
struct kroute_privs_t isisd_privs = {
...
\n\
Report bugs to http://bugzilla.bane.net\n", progname);
    }
...
struct bane_signal_t isisd_signals[] =
{
  {
   .signal = SIGHUP,
   .handler = &sighup,
...
main (int argc, char **argv, char **envp)
{
  ...
  /* Print banner. */
  zlog_notice ("Bane-ISISd %s starting: vty@%d", BANE_VERSION, vty_port);
